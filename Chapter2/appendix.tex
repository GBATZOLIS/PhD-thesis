    ...
    \begin{tabular}{lcccccccc}
        ...
        \begin{tabular}{@{}c@{}}
           CDiffE
            \\[25pt]
        \end{tabular} & 
            \includegraphics[width=.08\textwidth]{Chapter2/samples/extended_results/edges-to-shoes/1/CDiffE.png} & \includegraphics[width=.08\textwidth]{Chapter2/samples/extended_results/edges-to-shoes/6/CDiffE.png} & \includegraphics[width=.08\textwidth]{Chapter2/samples/extended_results/edges-to-shoes/8/CDiffE.png} &
            \includegraphics[width=.08\textwidth]{Chapter2/samples/extended_results/edges-to-shoes/10/CDiffE.png} &
            \includegraphics[width=.08\textwidth]{Chapter2/samples/extended_results/edges-to-shoes/21/CDiffE.png} &
            \includegraphics[width=.08\textwidth]{Chapter2/samples/extended_results/edges-to-shoes/99/CDiffE.png} &
            \includegraphics[width=.08\textwidth]{Chapter2/samples/extended_results/edges-to-shoes/126/CDiffE.png} &
            \includegraphics[width=.08\textwidth]{Chapter2/samples/extended_results/edges-to-shoes/134/CDiffE.png} \\
        ...
        \begin{tabular}{@{}c@{}}
            ...
            \\[25pt]
        \end{tabular}  &  
            \includegraphics[width=.08\textwidth]{Chapter2/samples/extended_results/edges-to-shoes/1/VS-CMDE.png} & \includegraphics[width=.08\textwidth]{Chapter2/samples/extended_results/edges-to-shoes/6/VS-CMDE.png} & \includegraphics[width=.08\textwidth]{Chapter2/samples/extended_results/edges-to-shoes/8/VS-CMDE.png} &
            \includegraphics[width=.08\textwidth]{Chapter2/samples/extended_results/edges-to-shoes/10/VS-CMDE.png} &
            \includegraphics[width=.08\textwidth]{Chapter2/samples/extended_results/edges-to-shoes/21/VS-CMDE.png} &
            \includegraphics[width=.08\textwidth]{Chapter2/samples/extended_results/edges-to-shoes/99/VS-CMDE.png} &
            \includegraphics[width=.08\textwidth]{Chapter2/samples/extended_results/edges-to-shoes/126/VS-CMDE.png} &
            \includegraphics[width=.08\textwidth]{Chapter2/samples/extended_results/edges-to-shoes/134/VS-CMDE.png} \\
    \end{tabular}
    \endgroup
    \end{center}
